...
global $_SITE_VAR_DOMPDF_DEFAULT_FONT;
if(!empty($_SITE_VAR_DOMPDF_DEFAULT_FONT) && strpos($_SITE_VAR_DOMPDF_DEFAULT_FONT, "/") !== false) {
    return [
        'serif' =>
                [
                    'normal' => $_SITE_VAR_DOMPDF_DEFAULT_FONT,
                    'bold' => $_SITE_VAR_DOMPDF_DEFAULT_FONT,
                    'italic' => $_SITE_VAR_DOMPDF_DEFAULT_FONT,
                    'bold_italic' => $_SITE_VAR_DOMPDF_DEFAULT_FONT
                ]
            ];
} 
else {
